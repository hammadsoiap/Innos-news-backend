...
class NewsApiMapper
{
    protected $nytMediaUrl='https://static01.nyt.com/' ;
    /**
     * @param array $data
     * @return array
     */
    ...
    {
        return array_map(function ($article) {
            $mediaUrl= (!empty($article['multimedia']) ? $article['multimedia'][0]['url'] : '');
            return [
                ...
                'image_url' =>$mediaUrl?$this->nytMediaUrl.$mediaUrl:null
            ];
        }, $data['response']['docs'] ?? []);
    }
